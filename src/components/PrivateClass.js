...
function PrivateClass() {
  ...
  return (
    <div>
      <img
        className="absolute pt-[3vw] ml-[40vw] w-[50vw] h-[70vw]"
      ...
      <div className="h-[35vw] w-full bg-no-repeat bg-center bg-pfc bg-cover flex flex-col align-middle justify-center">
        <h1 className="font-montserrat align-center text-left pl-[5vw] text-[5vw] w-[20vw] leading-tight font-extrabold text-white">
          PRIVATE CLASSROOM
        </h1>
        <p className="font-montserrat pt-[0.5vw] text-white text-[1.2vw] text-left pl-[5vw] leading-tight ">
      ...
      <div className="first-letter:flex h-[21vw] flex-col">
        <div className="mt-[13vw] ml-[26vw] align-center w-fit h-fit">
          ...
          <p
            ...
            className="font-montserrat absolute text-left text-[6vw] font-extrabold mt-[1vw] text-white"
          >
            HOW <br></br>
            IT WORKS
          </p>
      ...
      <div className="h-[40vw] flex flex-col">
        <img
          className="absolute ml-[20vw] mt-[4vw] w-[22vw] h-[19vw]"
          src={require("../assets/hiw-vector-3.png")}
          alt={"arrowdown"}
        />
        <h2 className="font-montserrat text-right text-[5vw] font-extrabold text-black pr-[10vw]">
          CREATE MISSION
        </h2>
        <p className="font-montserrat text-right text-black text-[1.2vw] leading-tight pr-[10vw] pl-[40vw]">
        ...
        <h2 className="font-montserrat text-left text-[5vw] font-extrabold text-black pl-[10vw] pt-[9vw]">
          SHARE
        </h2>
        <p className="font-montserrat text-left text-black text-[1.2vw] leading-tight pl-[10vw] pr-[55vw]">
      ...
      <div className="h-[45vw] flex flex-col">
        ...
        />
        <img
          className="absolute w-[30vw] h-[25vw] ml-[50vw] mt-[-25vw]"
          src={require("../assets/hiw-dave.png")}
          alt={"letsflip profile"}
        />
        <img
          className="absolute w-[34vw] h-[30vw] ml-[13vw] mt-[5vw]"
      ...
      <div className="h-fit flex flex-col">
        <p
          ...
          className="font-montserrat absolute text-center text-[6vw] font-extrabold pt-[2vw] pr-[1.5vw] text-white"
        >
          THROUGH LETS FLIP'S DEEP LEARNING JOURNEY
        </p>

        <h2 className="font-montserrat absolute text-center text-[6vw] font-extrabold pt-[2vw] z-[1] mt-[1.5vw] ">
          <Gradient dir="left-to-right" from="#FC5229" to="#AF067D">
            THROUGH LETS FLIP'S DEEP LEARNING JOURNEY
          </Gradient>
        </h2>
        ...
        <img
          className="flex pt-[22vw] place-self-center w-[55vw] h-[70vw] "
        ...
        <img
          className="flex place-self-center w-[30vw] rounded-3xl "
