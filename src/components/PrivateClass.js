  ...
  return (
    <div>
      ...
      <div className="h-[35vw] w-full bg-no-repeat bg-center bg-pfc bg-cover flex flex-col align-middle justify-center">
        <h1 className="align-center text-left pl-[5vw] text-[5vw] w-[20vw] leading-tight font-extrabold text-white">
          {" "}
          PRIVATE CLASSROOM
        </h1>
        ...
        <div className="flex-row hover:cursor-pointer inline-flex justify-start w-full h-[5vw] py-[2vw]">
          <div
            className="flex font-montserrat text-center bg-transparent tracking-wide text-white font-light text-[0.9vw] items-center justify-center align-middle rounded-full px-[3vw] mx-[5vw] w-fit h-[3vw]"
            style={{
              "box-shadow":
          ...
          <div
            className="flex hover:cursor-pointer font-montserrat text-center bg-transparent tracking-wide text-white font-light text-[0.9vw] items-center justify-center align-middle rounded-full px-[3vw] mx-[3vw] w-fit h-[3vw]"
            style={{
              "box-shadow":
                "rgb(255 255 255 / 16%) -2px -3px 7px, rgb(0 0 0 / 20%) 2px 4px 7px",
            }}>
